...
public class CommonFileItemReader<T> extends FlatFileItemReader<T> {
     ...
     public CommonFileItemReader(Class clz, String encodingRead, String fileResource) {
         setEncoding(encodingRead);
         fileSystemResource = new FileSystemResource(fileResource);
